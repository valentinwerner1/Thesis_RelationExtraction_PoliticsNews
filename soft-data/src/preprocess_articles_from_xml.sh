FILE=C:/Users/svawe/Thesis_RelationExtraction_PoliticsNews/soft-data/src/example
STANFORD_PROPERTY=C:/Users/svawe/UDPetrarch-for-Python3/UniversalPetrarch/preprocessing/config/StanfordCoreNLP-english.properties
...
python preprocess_parse.py ${FILE}/$PFILENAME
